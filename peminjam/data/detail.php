            ...
            <div class="card">
                <div class="row m-10">
                    ...
                    <div class="col text-center">
                        <img src="../../petugas/asset/Foto/<?php echo $result['Foto'];?>" height="450" alt="">
                    </div>
                    <div class="col" style="margin-top: 5rem;">
                        ...
                        <a href="baca.php?idbaca=<?php echo $result['IDbuku'];?>" class="btn btn-success my-4">Baca Sekarang!</a>
                    </div>
                </div>
            </div>   
        </div>
