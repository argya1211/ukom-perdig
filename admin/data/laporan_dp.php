        ...
        <div class="container">
            <div class="row">
                <div class="col text-center mt-3">
                    ...
                    <span>Data merupakan keseluruhan data Peminjaman buku di Asa Library</span>
                </div>
            </div>
            <div class="row">
            <table class="table my-2">
                ...
                $data = mysqli_query($koneksi, "SELECT * FROM tb_peminjaman");
                while ($d = mysqli_fetch_array($data)) {
                
                ?>
                <tbody>
                    <tr>
                    <th scope="row"><?php echo $d['id_peminjaman'];?></th>
